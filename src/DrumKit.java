...
public class DrumKit extends MouseAdapter {
	...
	private void getGoing() throws MalformedURLException {
		...
		String img = "download.jpg";
		// 9. Edit the next line to use your String variable
		drumLabelWithImage = createLabelImage(img);
		drumLabelWithImage.setBounds(1000, 500, 200, 250);
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (860 < e.getX() & e.getX() < 1060 & 353 < e.getY() & e.getY() < 603) {
			System.out.println("Drum Clicked!!");
			// 17. ...use the playSound method to play a drum sound.
			playSound("139507__robertmcdonald__drum-hit-3.wav");
		}
